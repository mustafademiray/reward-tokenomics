...
contract('Token', accounts => {
  ...
  it('should give rewards', async () => {
    ...
    //When we put a very low number that made the reward amount less than 1, which was rounded down to 0 by a division in the smart contract
    //This edge case happened because we used very small amounts of tokens for testing (i.e way less than 1 token)
